...
public class BankAppController {
	...
	public String fundTransfer(@RequestParam("senderAccountNo") int senderAccountNo, @RequestParam("receiverAccountNo") int receiverAccountNo,
		...
		//restTemplate.postForEntity("http://transaction-service/transactions/withdraw", senderTransaction, null);
		...
		//restTemplate.postForEntity("http://transaction-service/transactions", receiverTransaction, null);
	...
	public ModelAndView getStatement(@RequestParam("offset") int offset, @RequestParam("size") int size) {
		...
		CurrentDataSet currentDataSet = restTemplate.getForObject("http://bank-zuul/banktransaction/transactions", CurrentDataSet.class);
